...
describe("Desejável", () => {
  ...
  test("Deve listar os produtos com preço formatado.", async () => {
    listaCategorias.mockResolvedValue(PRODUTOS_FORMATADO_MOCK );
    const produtoFormatado = await processarOpcao("produtos-formatados");
    expect(produtoFormatado).toEqual(PRODUTOS_FORMATADO_MOCK );
  });
