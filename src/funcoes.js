...
function extrairPrimeiroNome(nome) {
    return nome.substring(0, nome.indexOf(" ", 0));
}
...
function calculaImposto(valor, categoria) {
    return ((categoria === "Alimentação") ? 0 : (valor * 0.1));
}
...
// (teste, 10) -> teste
// (fulano, 4) -> fula...
function truncar(str, tam = 5) {
    return ((str.length > tam) ? `${str.substring(0, tam)}...` : str);
}
...
// "   " -> undefined
// "      Maria " -> "Maria"
function validaTextoPreenchido(str) {
...
function validaData(date) {
    let patternValidaData = /^(((0[1-9]|[12][0-9]|3[01])([-.\/])(0[13578]|10|12)([-.\/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-.\/])(0[469]|11)([-.\/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-.\/])(02)([-.\/])(\d{4}))|((29)(\.|-|\/)(02)([-.\/])([02468][048]00))|((29)([-.\/])(02)([-.\/])([13579][26]00))|((29)([-.\/])(02)([-.\/])([0-9][0-9][0][48]))|((29)([-.\/])(02)([-.\/])([0-9][0-9][2468][048]))|((29)([-.\/])(02)([-.\/])([0-9][0-9][13579][26])))$/;

    return ((patternValidaData.test(date)) ? "Ok" : NaN);
}
