...
// (30, Alimentação) => 0
// (10, Bebida) => 1
const calculaImposto = (valor, categoria) =>
  categoria !== "Alimentação" ? valor * 0.1 : 0;
...
// (10, Bebida, XPTO) => 10
const calculaDesconto = (preco, categoria, cupom) =>
