...
describe("Essencial", () => {
  ...
  test ("Deve tratar erros 404.", () => {
    ...
    expect(listarProdutos()).rejects.toThrow("Não encontrado: 404");
    expect(listarCategorias()).rejects.toThrow("Não encontrado: 404");
    expect(listarCupons()).rejects.toThrow("Não encontrado: 404");
  });
});
